      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
        <div>
          ...
          <p style={{ fontSize: '15px', color: '#666' }}>
            Urus semua post news feed anda
          </p>
        </div>
        <Link
          href="/merchant/dashboard/newsfeed/new"
          style={{
            display: 'inline-flex',
            alignItems: 'center',
            gap: '8px',
      ...
      {posts.length > 0 ? (
              ...
              <div style={{ display: 'flex', gap: '24px' }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '12px' }}>
                    <h3 style={{ fontSize: '20px', fontWeight: '700', color: '#2C2C2C' }}>
                      {post.title}
                    </h3>
                    <div style={{
                      padding: '6px 16px',
                      ...
                      fontSize: '12px',
                      fontWeight: '700',
                      backgroundColor: post.is_published ? '#E8F5E9' : '#F5F5F5',
                      color: post.is_published ? '#2E7D32' : '#666'
                    }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    <Link
                      href={`/merchant/dashboard/newsfeed/edit/${post.id}`}
                      style={{
                        padding: '8px 16px',
                        backgroundColor: '#F5F5F0',
                        color: '#2C2C2C',
                    ...
                    <button
                      ...
                      style={{
                        padding: '8px 16px',
                        backgroundColor: deleting === post.id ? '#CCC' : '#FEE',
                        color: deleting === post.id ? '#666' : '#C33',
                        border: 'none',
                        borderRadius: '8px',
                        fontSize: '14px',
                        fontWeight: '600',
        ...
        <div style={{ 
          ...
          <p style={{ fontSize: '16px', color: '#666', marginBottom: '24px' }}>
            Mulakan dengan menambah post news feed pertama anda
          </p>
          <Link
            href="/merchant/dashboard/newsfeed/new"
            style={{
